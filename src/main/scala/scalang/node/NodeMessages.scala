...
case class MonitorMessage(from : Pid, to : Pid, ref : Reference)

case class DemonitorMessage(from : Pid, to : Pid, ref : Reference)

case class MonitorExitMessage(from : Pid, to : Pid, ref : Reference, reason : Any)
